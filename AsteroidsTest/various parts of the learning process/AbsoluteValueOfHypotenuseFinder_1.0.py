...
screen_center = center_width, center_height = (SCREEN_WIDTH // 2), (SCREEN_HEIGHT // 2)
...
def report_x_y_and_draw_a_line():
	...
	pygame.draw.line(screen, WHITE, [screen_center[0], screen_center[1]], [mouse_position[0], mouse_position[1]], 1)
...
print("Hint: Click somewhere in the Pygame screen!\n")
