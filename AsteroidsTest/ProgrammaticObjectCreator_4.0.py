...
## This was made to facilitate development of my Asteroids! clone's programmatically-defined art assets.
## You can use it by left clicking once inside the green square on the screen that pops up to start drawing a line, then left clicking again somewhere else to finish drawing it.
## I'm pretty sure the green square is the extent of the object's hitbox in-game, and you can actually draw outside it too. Probably.
## KEY COMMANDS:
## - s saves your design and quits the program
## - r cancels the current line
## - g will remove a line you've just drawn
## - q has the same function as left clicking
## - esc quits without saving
## The design will be written to a text file in the same directory as this program.
## In order to incorporate your design into the Asteroids! game, simply copy and paste the contents of the file over the similarly-formatted data inside the game's draw_programmatic_object() function.
## Or comment out the appropriate line and simply put this beneath it.
